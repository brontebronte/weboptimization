...
var resizePizzas = function(size) {
  ...
  // Iterates through pizza elements on the page and changes their widths and innerHTML size category
...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(bodyScroll + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPiz = document.getElementById("movingPizzas1");
  for (var i = 0; i < 30; i++) {
    var elem = document.createElement('img');
    elem.className = 'mover';
    elem.src = "minified pizza/imagesmin/pizza.png";
    elem.style.height = "100px";
    elem.style.width = "73.333px";
    elem.basicLeft = (i % cols) * s;
    elem.style.top = (Math.floor(i / cols) * s) + 'px';
    movingPiz.appendChild(elem);
  }
  updatePositions();
});
